...
public class SettingsHostActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
        ...
        else {//if the Bundle sent into onCreate method is empty then just attach the Settings Fragment to the host Activity
            ...
            //use getFragmentManager because you are using a Preference Fragment via SettingsFragment in add(), Preference Fragment does not support supportFragmentManager because Preference Fragment created before Fragments existed in Android
